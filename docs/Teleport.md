...
如果距离这一次的点位不足50米 则会通过设定的倍率来减少延迟以提高效率。

- 例: 距离不足50米 自动传送的延迟为20秒 设定此项为0.75 则延迟为20秒*0.75=15秒。
...
- 可加载第三方传送文件 有关获取传送文件以及更多信息请移步至 [JSON传送](/JSON_Teleport) 。
